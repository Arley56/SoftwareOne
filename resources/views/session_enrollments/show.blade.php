    ...
    <x-slot name="header">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
            <div>
                ...
                <p class="text-secondary mb-0">Consulta la información de la monitoría y el material compartido por el monitor.</p>
            </div>
        ...
        <div class="card border-0 shadow-sm bg-dark text-light mb-4">
            <div class="card-header border-secondary d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div>
                    ...
                    <small class="text-secondary">Material compartido por el monitor para esta monitoría.</small>
                </div>
                <span class="badge text-bg-info text-dark">{{ $sessionEnrollment->monitorSession->sessionMaterials->count() }} archivos</span>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-dark table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center text-secondary py-5">Todavía no se ha cargado material de apoyo para esta monitoría.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
