...
@section('content')
    <div class="container-fluid">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-3">
            <div>
                <h2 class="text-light fw-bold mb-1">Sesiones</h2>
            ...
            <div class="bg-dark border-top border-secondary px-4 py-3">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                    ...
                    <div class="text-secondary small">
                        Mostrando
                        {{ $sessions->firstItem() ?? 0 }}
                        a
                        {{ $sessions->lastItem() ?? 0 }}
                        de
                        <strong class="text-light">{{ $sessions->total() ?? 0 }}</strong>
                        resultados
                    </div>

                    {{-- PAGINADOR --}}
                    <div class="custom-pagination">
                        {{ $sessions->onEachSide(1)->links('pagination::bootstrap-5') }}
                    </div>
