                ...
                <div class="card border-0 shadow-sm bg-dark text-white">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            <a href="{{ route('monitor_sessions.index') }}" class="btn btn-success">Ver sesiones</a>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card bg-dark text-white border-secondary h-100">
                <div class="card-body">
                    ...
                    <a href="{{ route('monitor_sessions.index') }}" class="btn btn-sm btn-outline-info mt-3">Ver módulo</a>
                </div>
            </div>
        </div>
    </div>
